...
*******************************************************************************/
var rt_app_level_event = {

  $RTAppLevelEventModule: {

    onAudioInterruptionEnd: function() {
      RTModule.sendMessage("RTAppLevelEvent", "_onAudioInterruptionEndCallback");
    },

    onAudioInterruptionBegin: function() {
      RTModule.sendMessage("RTAppLevelEvent", "_onAudioInterruptionBeginCallback");
    },

    onError: function(res) {
      RTModule.sendMessage("RTAppLevelEvent", "_onErrorCallback", res.message);
    }

  },

  RTOnAudioInterruptionBegin: function() {
    RTModule.runtime.onAudioInterruptionBegin(RTAppLevelEventModule.onAudioInterruptionBegin);
  },

  RTOffAudioInterruptionBegin: function() {
    RTModule.runtime.offAudioInterruptionBegin(RTAppLevelEventModule.onAudioInterruptionBegin);
  },

  RTOnAudioInterruptionEnd: function() {
    RTModule.runtime.onAudioInterruptionEnd(RTAppLevelEventModule.onAudioInterruptionEnd);
  },

  RTOffAudioInterruptionEnd: function() {
    RTModule.runtime.offAudioInterruptionEnd(RTAppLevelEventModule.onAudioInterruptionEnd);
  },

  RTOnError: function() {
    RTModule.runtime.onError(RTAppLevelEventModule.onError);
  },

  RTOffError: function() {
    RTModule.runtime.offError(RTAppLevelEventModule.onError);
  }

};

autoAddDeps(rt_app_level_event, "$RTAppLevelEventModule");
mergeInto(LibraryManager.library, rt_app_level_event);
