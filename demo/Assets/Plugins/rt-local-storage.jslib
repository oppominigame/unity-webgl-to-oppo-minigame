...
mergeInto(LibraryManager.library, {
  ...
  RTLocalStorageGetItem: function(key) {
  ...
  RTLocalStorageSetItem: function(key, value) {
    localStorage.setItem(Pointer_stringify(key), Pointer_stringify(value));
  },

  RTLocalStorageRemoveItem: function(key) {
    localStorage.removeItem(Pointer_stringify(key));
  },

  RTLocalStorageClear: function() {
    localStorage.clear();
  },

  RTLocalStorageKey: function(index) {
